...
if (!function_exists('aidunite_enqueue_team_activity_fields_script')) {
    function aidunite_enqueue_team_activity_fields_script() {
        ...
        $done = true;
        $js = get_stylesheet_directory() . '/assets/js/team/team-activity-fields.js';
        if (is_readable($js)) {
            wp_enqueue_script(
                'aidunite-team-activity-fields',
                get_stylesheet_directory_uri() . '/assets/js/team/team-activity-fields.js',
                [],
                (string) filemtime($js),
                true
            );
...
if (!function_exists('aidunite_render_team_activity_fields')) {
    ...
    function aidunite_render_team_activity_fields($team_id = 0, $args = []) {
        ...
        if ($is_wp_admin) {
            $admin_css = get_stylesheet_directory() . '/assets/css/admin/team-activity-fields-wp-admin.css';
            if (is_readable($admin_css)) {
                wp_enqueue_style(
                    'aidunite-team-activity-fields-wp-admin',
                    get_stylesheet_directory_uri() . '/assets/css/admin/team-activity-fields-wp-admin.css',
                    [],
