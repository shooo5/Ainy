/** schedule-calendar-bootstrap.js */
window.currentDate = window.currentDate || new Date();
    ...
    function goToScheduleEdit(dateString) {
        ...
        var bootCfg = window.aiduniteScheduleCalendarBootstrap || {};
        const editBase = bootCfg.scheduleEditUrl || '/schedule-management/';
        const editUrl = editBase.replace(/\/?$/, '/') + '?open_register=' + encodeURIComponent(dateString);
